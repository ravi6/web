...
var obj = {
  "ragas": [
	...
	"PariPaalaYa MaaM Sri PadmaNabha MuraaRe",
	"JanaNi NinuVina DikkeVaRamma JagamuLoNa Gana",
        "Brindaavana Nilayer",
        "Aadi Vinaayakam",
        "SathguruSwaamikai",
        "Raaga Ratna MaaliKaChe Ranjillu NataHari",
      ],
      "notes": {
	...
	"Rama ChandruDiTadu Raghu VeeruDu",
      ...
      "notes": {
        ...
        "avarohana": "S N2 D2 P M1 G3 M1 R2 G2 R2 S"
      }
    },
	...
	"Bhogeendra SaiNam Guru Kusala Daayinam",
      ...
      "notes": {
        "aarohana": "S M1 P D2 N2 D2 S",
        "avarohana": "S N2 D2 P M1 S"
      }
    },
	...
	"Palukavemi Naa Daivama Rama",
      ...
      "notes": {
        ...
        "avarohana": "S N3 P M1 R2 G3 M1 R2 S"
      }
    },
	...
	"Sita Vara SangeeTa",
      ...
      "notes": {
        "aarohana": "S R2 M1 P D2 S",
        "avarohana": "S N3 D2 N2 D2 P M1 G3 R2 S"
      }
    },
...

    {
      ...
      "kritis": [
       ...
       "Sarada Sadaa VasTu MuDaRaSa Naya MaaMaDhya",
	...
	"SrinGaaRa LaHare SriTaJana SuKhaKaaRi",
      ...
      "notes": {
        ...
        "avarohana": "S N3 P D2 N2 P M1 G3 R2 M1 G3 S"
      }
    },
...

    {
      "name": "gana sammodini",
      "kritis": [
	"Govinda NamaVe Chanda",
      ],
      "notes": {
        "aarohana":  "S R2 G3 P D1 S",
        "avarohana": "S D1 P G3 R2 S"
      }
    },
...

    {
      "name": "rama priya",
      "kritis": [
	"Korina VaraMosaGu NeeVu KodanDa Pani",
      ],
      "notes": {
        "aarohana": "S R1 G3 P D2 N2 S",
	...
	"Bhajana Seya RaaMuni Seeta Ramuni",
	"EtuLaiNa Bhakti VachuTaKe YatNaMu SeyaVe ManaSa",
	"Manasa SanCharaRe BrahMani",
	"MaravaKaVe Oh ManaSa Naa RaaMuNi",
      ],
      "notes": {
        "aarohana": "S R2 M1 P D2 S",
        "avarohana": "S D2 P M1 G3 R2 S"
	...
	"MaaMaVa RaghuRamaa MaraKatha Syama",
      ],
      "notes": {
	...
	"VaraLanDu KommaNi NaaYanDu VanchaNa Seya NyaMa",
      ],
      "notes": {
        "aarohana":  "S R1 G3 M1 P D1 N3 S",
...

    {
      "name": "madhuvanti",
      "kritis": [
        "GuruVara DeeJo CharaNa TuMaaRe",
      ],
      "notes": {
