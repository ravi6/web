...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("tcl",(()=>{"use strict";function e(...e){
...
variants:[a.inherit(a.QUOTE_STRING_MODE,{illegal:null})]},r]};var n}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
